	...
	<form class="layui-form" action="" name="actionForm" method="POST" enctype="multipart/form-data">
		...
		<fieldset class="layui-elem-field" style="width: 60%; text-align: center; margin-left: 20%;">
			...
			<div class="layui-form-item">
		  	...
		  	<div class="layui-form-item">
			  	<label class="layui-form-label">乐豆数量</label>
			    <div class="layui-input-inline" style="width:70%">
			        <input type="number" name="score" lay-verify=""  id="score" value="${(record.score?c)!100}" placeholder="0" autocomplete="off" class="layui-input">
		  		</div>
		  		<div class="layui-form-mid layui-word-aux"><span style="color:red;">商品兑换需要乐豆数量*</span></div>
		  	</div>
		  	<div class="layui-form-item">
		  	...
		  	<div class="layui-form-item">
			    ...
			    <div class="layui-input-inline" style="width:70%">
			        <input type="text" name="realSales" lay-verify="" value="${(record.realSales?c)!'0'}"  id="realSales" placeholder="0" autocomplete="off" class="layui-input" readonly="readonly">
		  		</div>
		  		<div class="layui-form-mid layui-word-aux"><span style="color:red;">*</span></div>
		  	</div>
		  	 <div class="layui-form-item">
		  	...
		  	<div class="layui-form-item">
			  	<label class="layui-form-label">是否需要折扣券兑换</label>
			     <div class="layui-input-inline" style="width:70%">
		  	...
		  	<div class="layui-form-item">
			     ...
			     <div class="layui-input-inline" style="width:70%">
			      	<select name="categoriesId" lay-verify="" id="categoriesId">
			      		<option value="">--请选择--</option>
			      		<#if goodClassList??>
	...
	<script>
		...
		layui.use('form', function(){
		  ...
		  form.on('submit(formDemo)', function(data){
		  	...
		  	document.actionForm.action="${request.contextPath}/backpage/beanGoods/input";
