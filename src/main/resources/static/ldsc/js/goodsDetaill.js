			...
			success : function(data) {
				...
				if (data!=null) {
					$.each(data, function(i, n){
						...
						if(i==0){
							resultString+='<li class="cardlist selectOne" id="'+n.ticket_id+'" value="'+n.value+'"><span class="selectDot"></span>'+n.value+'乐豆抵扣券</li>';
						}else{
							resultString+='<li class="cardlist" id="'+n.ticket_id+'" value="'+n.value+'"><span></span>'+n.value+'乐豆抵扣券</li>';
						}
					});
